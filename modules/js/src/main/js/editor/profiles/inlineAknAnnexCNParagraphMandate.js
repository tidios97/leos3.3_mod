 ...
 */
; // jshint ignore:line
define(function aknAnnexCNParagraphMandateProfileModule(require) {
     "use strict";
    ...
    var profileConfig = {
        ...
        toolbar : [
            ...
            { name: 'soft_insert', items: [ 'leosHierarchicalElementShiftEnterHandler', 'leosElementMerge', 'leosHierarchicalElementSubparagraphAfterLastPoint' ] },
