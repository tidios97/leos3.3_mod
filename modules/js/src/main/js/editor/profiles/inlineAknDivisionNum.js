 ...
 */
; // jshint ignore:line
define(function aknDivisionNumProfileModule(require) {
    "use strict";
    ...
    var plugins = [];
    plugins.push(require("plugins/aknDivisionNum/aknDivisionNumPlugin"));
    ...
    var profileName = "Inline AKN Division Num";
