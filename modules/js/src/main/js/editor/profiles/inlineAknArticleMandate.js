 ...
 */
; // jshint ignore:line
define(function aknInlineArticleMandateProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknArticleMandate/aknArticleMandatePlugin"));
    ...
    var profileName = "Inline AKN Article Mandate";
