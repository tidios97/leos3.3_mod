 ...
 */
; // jshint ignore:line
define(function aknInlinePointMandateProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknPointMandate/aknPointMandatePlugin"));
    ...
    var profileName = "Inline AKN Point Mandate";
