 ...
 */
; // jshint ignore:line
define(function aknExplanatoryParagraphProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknListParagraph/aknListParagraphPlugin"));
    ...
    plugins.push(require("plugins/aknCrossHeading/aknCrossHeadingPlugin"));
    plugins.push(require("plugins/leosUnumberedList/leosUnumberedListPlugin"));
    plugins.push(require("plugins/leosPointCrossHeading/leosPointCrossHeadingPlugin"));
    ...
    var profileName = "Inline AKN Annex Paragraph Mandate";
    ...
    var profileConfig = {
        ...
        toolbar : [ {
            ...
            name: "ref",
            items : [ "authorialNoteWidget", "LeosCrossReference" ]
        },'/', {
            name : "align",
        ...
        removeButtons: "Anchor,TextColor,PasteFromWord,PasteText",
