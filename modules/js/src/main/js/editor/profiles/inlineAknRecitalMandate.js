 ...
 */
; // jshint ignore:line
define(function aknRecitalMandateProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknRecitalMandate/aknRecitalMandatePlugin"));
    ...
    var profileName = "AKN Recital Mandate";
