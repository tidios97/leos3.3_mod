 ...
 */
; // jshint ignore:line
define(function aknCitationMandateProfileModule(require) {
    "use strict";
    ...
    plugins.push(require("plugins/aknCitationMandate/aknCitationMandatePlugin"));
    ...
    var profileName = "AKN Citation Mandate";
    ...
    var profileConfig = {
        ...
        plugins: "toolbar,wysiwygarea,elementspath," +
                 ...
                 "button,dialog,dialogui,contextmenu,menubutton,widget",
