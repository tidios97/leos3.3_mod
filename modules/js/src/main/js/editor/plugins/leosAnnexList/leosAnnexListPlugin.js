...
; // jshint ignore:line
define(function leosAnnexListPluginModule(require) {
    "use strict";
    ...
    CKEDITOR.plugins.leosAnnexList = {
        /**
        ...
        listToArray: function( listNode, database, baseArray, baseIndentLevel, grandparentNode ) {
            ...
            for ( var i = 0, count = listNode.getChildCount(); i < count; i++ ) {
                ...
                if ( listItem.type == CKEDITOR.NODE_ELEMENT && listItem.getName() in CKEDITOR.dtd.$list )
                    CKEDITOR.plugins.leosAnnexList.listToArray( listItem, database, baseArray, baseIndentLevel + 1 );

                // It may be a text node or some funny stuff.
                if ( listItem.$.nodeName.toLowerCase() != 'li' && !leosPluginUtils.isSubparagraph(listItem))
                    continue;
                ...
                for ( var j = 0, itemChildCount = listItem.getChildCount(), child; j < itemChildCount; j++ ) {
                    ...
                    if ( child.type == CKEDITOR.NODE_ELEMENT && listNodeNames[ child.getName() ] )
                        ...
                        CKEDITOR.plugins.leosAnnexList.listToArray( child, database, baseArray, baseIndentLevel + 1, itemObj.grandparent );
                    else
            ...
            while ( 1 ) {
                ...
                if ( item.indent == indentLevel ) {
                    ...
                    var currDir = listArray[ currentIndex - 1 ].element.getDirection( 1 ),
                        listData = CKEDITOR.plugins.leosAnnexList.arrayToList( listArray, null, currentIndex, paragraphMode, currDir != orgDir ? orgDir : null );
    ...
    function changeListType( editor, groupObj, database, listsCreated ) {
        ...
        var listArray = CKEDITOR.plugins.leosAnnexList.listToArray( groupObj.root, database ),
            selectedListItems = [];
        ...
        var newList = CKEDITOR.plugins.leosAnnexList.arrayToList( listArray, database, null, editor.config.enterMode );
        var child,
    ...
    function removeList( editor, groupObj, database ) {
        ...
        var newList = CKEDITOR.plugins.leosAnnexList.arrayToList( listArray, database, null, editor.config.enterMode, groupObj.root.getAttribute( 'dir' ) );
