...
define(function aknAuthorialNotePluginModule(require) {
    ...
    var pluginDefinition = {
        ...
        init : function init(editor) {
            ...
            editor.on("toHtml", _restoreBlockMpsAfterTranform, null, null, 6);      // LEOS-4492
    ...
    function _manageSpacesForMpsBeforeTranform(evt) { // LEOS-4492
        // this allows the maintenance of trailing spaces in authorial notes' mps during CKEDITOR's HTML transformation
        CKEDITOR.dtd.$block['mp'] = 0;
    }

    function _restoreBlockMpsAfterTranform(evt) { // LEOS-4492
        // After transformation, restore <mp> tag as block so that it will not be wrapped in <p> tag
