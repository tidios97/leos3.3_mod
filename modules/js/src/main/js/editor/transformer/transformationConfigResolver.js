    ...
    var transformationConfigResolverStamp = STAMPIT().methods(
            {
                ...
                _resolveConfigsByAttribute : function _resolveConfigsByAttribute(context) {
                    ...
                    context.matchedConfigs.forEach(function(config) {
                        ...
                        if (!!firstLevelFromAttribute && !!firstLevelFromAttributeValue && context.element.attributes[firstLevelFromAttribute.toLowerCase()] === firstLevelFromAttributeValue) {
                        ...
                        } else if (!!firstLevelFromAttribute && context.element.attributes.hasOwnProperty(firstLevelFromAttribute.toLowerCase()) && !firstLevelFromAttributeValue) {
