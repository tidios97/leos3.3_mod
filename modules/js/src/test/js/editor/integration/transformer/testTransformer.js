                                    ...
                                    function() {
                                        ...
                                        describe("Test akn ordered list.", function() {
                                            describe("Expects to transform akn ordered list back and forth correctly.", function() {
                                                ...
                                                var htmlFragmentInHtml = '<ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-name="point" data-akn-num="1.">content 1</li></ol>';
                                                expectFragmentToBeTransformedCorrectly(aknFragmentInHtml, htmlFragmentInHtml, allConfigs);
                                            });
                                    ...
                                    function() {
                                        ...
                                        describe(
                                                ...
                                                function() {
                                                    ...
                                                    var htmlFragmentInHtml = '<li data-akn-name="aknNumberedParagraph" data-akn-element="paragraph" data-akn-num="1"><p data-akn-element="subparagraph">Sub-Paragraph 1</p><p data-akn-element="subparagraph">Sub-Paragraph 2</p></li>';
                                        ...
                                        describe(
                                                ...
                                                function() {
                                                    ...
                                                    var htmlFragmentInHtml = '<li data-akn-name="aknNumberedParagraph" data-akn-element="paragraph" data-akn-num="1"><p data-akn-element="subparagraph"><strong>Sub-Paragraph 1</strong></p><p data-akn-element="subparagraph"><em>Sub-Paragraph 2</em></p></li>';
                                                    describe(
                                        ...
                                        describe(
                                                ...
                                                function() {
                                                    ...
                                                    var htmlFragmentInHtml = '<li data-akn-name="aknNumberedParagraph" data-akn-element="paragraph" data-akn-num="1"><p data-akn-element="subparagraph">Sub-Paragraph 1</p></li>';
                                                    describe(
