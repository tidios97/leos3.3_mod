                                                    ...
                                                    var fragmentMock = {
                                                        mapToProducts : function() {
                                                            expect(JSON.stringify(arguments[1])).toEqual(
                                                                    '[{"toPath":"list/indent","attrs":[{"from":"id","to":"xml:id","action":"passAttributeTransformer"},{"from":"data-origin","to":"leos:origin","action":"passAttributeTransformer"},{"from":"data-akn-attr-editable","to":"leos:editable","action":"passAttributeTransformer"},{"from":"leos:originaldepth","to":"leos:originaldepth","action":"passAttributeTransformer"},{"from":"data-indent-level","to":"leos:indent-level","action":"passAttributeTransformer"},{"from":"data-indent-numbered","to":"leos:indent-numbered","action":"passAttributeTransformer"},{"from":"data-indent-origin-indent-level","to":"leos:indent-origin-indent-level","action":"passAttributeTransformer"},{"from":"data-indent-origin-num","to":"leos:indent-origin-num","action":"passAttributeTransformer"},{"from":"data-indent-origin-num-id","to":"leos:indent-origin-num-id","action":"passAttributeTransformer"},{"from":"data-indent-origin-num-origin","to":"leos:indent-origin-num-origin","action":"passAttributeTransformer"},{"from":"data-indent-origin-type","to":"leos:indent-origin-type","action":"passAttributeTransformer"},{"from":"data-indent-unumbered-paragraph","to":"leos:indent-unumbered-paragraph","action":"passAttributeTransformer"},{"from":"data-akn-attr-softaction","to":"leos:softaction","action":"passAttributeTransformer"},{"from":"data-akn-attr-softactionroot","to":"leos:softactionroot","action":"passAttributeTransformer"},{"from":"data-akn-attr-softuser","to":"leos:softuser","action":"passAttributeTransformer"},{"from":"data-akn-attr-softdate","to":"leos:softdate","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_to","to":"leos:softmove_to","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_from","to":"leos:softmove_from","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_label","to":"leos:softmove_label","action":"passAttributeTransformer"},{"from":"data-akn-attr-softtrans_from","to":"leos:softtrans_from","action":"passAttributeTransformer"},{"from":"data-akn-attr-renumbered","to":"leos:renumbered","action":"passAttributeTransformer"}]},{"toPath":"list/indent/num","attrs":[{"from":"data-akn-num-id","to":"xml:id","action":"passAttributeTransformer"},{"from":"data-num-origin","to":"leos:origin","action":"passAttributeTransformer"},{"from":"data-akn-num-attr-softaction","to":"leos:softaction","action":"passAttributeTransformer"},{"from":"data-akn-num-attr-softactionroot","to":"leos:softactionroot","action":"passAttributeTransformer"},{"from":"data-akn-num-attr-softuser","to":"leos:softuser","action":"passAttributeTransformer"},{"from":"data-akn-num-attr-softdate","to":"leos:softdate","action":"passAttributeTransformer"}]},{"toPath":"list/indent/num/text","fromAttribute":"data-akn-num"}]');
                                                        },
                                        ...
                                        it("Element with inline content, nested inline content wrapped with p and block content .",
                                                function() {
                                                    ...
                                                    var fragmentMock = {
                                                        ...
                                                        mapToChildProducts : function() {
                                                            if (mapToChildProductsCounter === 0) {
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"list/indent","toChild":"alinea","attrs":[{"from":"id","to":"xml:id","action":"passAttributeTransformer"},{"from":"data-origin","to":"leos:origin","action":"passAttributeTransformer"},{"from":"data-akn-attr-softaction","to":"leos:softaction","action":"passAttributeTransformer"},{"from":"data-akn-attr-softactionroot","to":"leos:softactionroot","action":"passAttributeTransformer"},{"from":"data-akn-attr-softuser","to":"leos:softuser","action":"passAttributeTransformer"},{"from":"data-akn-attr-softdate","to":"leos:softdate","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_to","to":"leos:softmove_to","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_from","to":"leos:softmove_from","action":"passAttributeTransformer"},{"from":"data-akn-attr-softmove_label","to":"leos:softmove_label","action":"passAttributeTransformer"},{"from":"data-akn-attr-softtrans_from","to":"leos:softtrans_from","action":"passAttributeTransformer"},{"from":"contenteditable","to":"leos:editable","action":"passAttributeTransformer"},{"from":"data-indent-origin-type","to":"leos:indent-origin-type","action":"passAttributeTransformer"},{"from":"data-indent-origin-num","to":"leos:indent-origin-num","action":"passAttributeTransformer"},{"from":"data-indent-origin-num-id","to":"leos:indent-origin-num-id","action":"passAttributeTransformer"},{"from":"data-indent-origin-num-origin","to":"leos:indent-origin-num-origin","action":"passAttributeTransformer"}]}');
                                                            } else if (mapToChildProductsCounter === 1) {
                                                                expect(JSON.stringify(arguments[1])).toEqual(
                                                                        '{"toPath":"list/indent/alinea","toChild":"content","attrs":[{"from":"data-akn-content-id","to":"xml:id","action":"passAttributeTransformer"},{"from":"data-content-origin","to":"leos:origin","action":"passAttributeTransformer"}]}');
                                                            } else if (mapToChildProductsCounter === 2) {
                                            ...
                                            var fragmentMock = {
                                                mapToProducts : function() {
                                                    if(mapToProductsCounter === 0) {
                                                        expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul/li","attrs":[{"from":"xml:id","to":"data-akn-num-id","action":"passAttributeTransformer"},{"from":"leos:origin","to":"data-num-origin","action":"passAttributeTransformer"},{"from":"leos:softaction","to":"data-akn-num-attr-softaction","action":"passAttributeTransformer"},{"from":"leos:softactionroot","to":"data-akn-num-attr-softactionroot","action":"passAttributeTransformer"},{"from":"leos:softuser","to":"data-akn-num-attr-softuser","action":"passAttributeTransformer"},{"from":"leos:softdate","to":"data-akn-num-attr-softdate","action":"passAttributeTransformer"}]}');
                                                ...
                                                mapToChildProducts : function() {
                                                    if (mapToChildProductsCounter === 0) {
                                                        expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul","toChild":"li","attrs":[{"from":"xml:id","to":"id","action":"passAttributeTransformer"},{"from":"leos:crossheading-type","to":"data-akn-crossheading-type","action":"passAttributeTransformer"},{"from":"style","to":"style","action":"passAttributeTransformer"},{"from":"leos:origin","to":"data-origin","action":"passAttributeTransformer"},{"from":"leos:editable","to":"data-akn-attr-editable","action":"passAttributeTransformer"},{"from":"leos:editable","to":"contenteditable","action":"passAttributeTransformer"},{"from":"leos:originaldepth","to":"leos:originaldepth","action":"passAttributeTransformer"},{"from":"leos:indent-level","to":"data-indent-level","action":"passAttributeTransformer"},{"from":"leos:indent-numbered","to":"data-indent-numbered","action":"passAttributeTransformer"},{"from":"leos:indent-origin-indent-level","to":"data-indent-origin-indent-level","action":"passAttributeTransformer"},{"from":"leos:indent-origin-num","to":"data-indent-origin-num","action":"passAttributeTransformer"},{"from":"leos:indent-origin-num-id","to":"data-indent-origin-num-id","action":"passAttributeTransformer"},{"from":"leos:indent-origin-num-origin","to":"data-indent-origin-num-origin","action":"passAttributeTransformer"},{"from":"leos:indent-origin-type","to":"data-indent-origin-type","action":"passAttributeTransformer"},{"from":"leos:indent-unumbered-paragraph","to":"data-indent-unumbered-paragraph","action":"passAttributeTransformer"},{"from":"leos:softaction","to":"data-akn-attr-softaction","action":"passAttributeTransformer"},{"from":"leos:softactionroot","to":"data-akn-attr-softactionroot","action":"passAttributeTransformer"},{"from":"leos:softuser","to":"data-akn-attr-softuser","action":"passAttributeTransformer"},{"from":"leos:softdate","to":"data-akn-attr-softdate","action":"passAttributeTransformer"},{"from":"leos:softmove_to","to":"data-akn-attr-softmove_to","action":"passAttributeTransformer"},{"from":"leos:softmove_from","to":"data-akn-attr-softmove_from","action":"passAttributeTransformer"},{"from":"leos:softmove_label","to":"data-akn-attr-softmove_label","action":"passAttributeTransformer"},{"from":"leos:softtrans_from","to":"data-akn-attr-softtrans_from","action":"passAttributeTransformer"},{"to":"data-akn-element","toValue":"indent","action":"passAttributeTransformer"},{"to":"data-akn-name","toValue":"indent","action":"passAttributeTransformer"},{"from":"leos:renumbered","to":"data-akn-attr-renumbered","action":"passAttributeTransformer"}]}');
                                                    } else if (mapToChildProductsCounter === 1) {
                                                        expect(JSON.stringify(arguments[1])).toEqual(
                                                    ...
                                                    var fragmentMock = {
                                                        ...
                                                        mapToChildProducts : function() {
                                                            if (mapToChildProductsCounter === 0) {
                                                                ...
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul/li","toChild":"p","attrs":[{"to":"id","toValue":"","action":"passAttributeTransformer"},{"to":"data-origin","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softaction","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softactionroot","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softuser","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softdate","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softmove_to","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softmove_from","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softmove_label","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-attr-softtrans_from","toValue":"","action":"passAttributeTransformer"},{"to":"contenteditable","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-wrapped-content-id","toValue":"","action":"passAttributeTransformer"},{"to":"data-wrapped-content-origin","toValue":"","action":"passAttributeTransformer"},{"from":"xml:id","to":"data-akn-mp-id","action":"passAttributeTransformer"},{"from":"leos:origin","to":"data-mp-origin","action":"passAttributeTransformer"},{"to":"data-indent-origin-type","toValue":"","action":"passAttributeTransformer"},{"to":"data-indent-origin-num","toValue":"","action":"passAttributeTransformer"},{"to":"data-indent-origin-num-id","toValue":"","action":"passAttributeTransformer"},{"to":"data-indent-origin-num-origin","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-element","toValue":"alinea","action":"passAttributeTransformer"}]}');
                                                            } else if (mapToChildProductsCounter === 2) {
                                        ...
                                        it("Element with table and nested inline content.",
                                                function() {
                                                    ...
                                                    var fragmentMock = {
                                                        ...
                                                        mapToNestedChildProduct : function() {
                                                            if (mapToNestedChildProductCounter === 0) {
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul/li","attrs":[{"to":"data-akn-alinea-id","toValue":"","action":"passAttributeTransformer"},{"to":"data-alinea-origin","toValue":"","action":"passAttributeTransformer"},{"to":"data-wrapped-content-origin","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-wrapped-content-id","toValue":"","action":"passAttributeTransformer"},{"to":"data-akn-element","toValue":"alinea","action":"passAttributeTransformer"}]}');
                                                            } else {
                                                                // expect not to be called for mapToChildProductsCounter > 2
                                                                expect(true).toBe(false);
                                                            }
