...
class MetadataMandateForm extends FormLayout {
    ...
    MetadataMandateForm(final DocumentVO document, MessageHelper messageHelper, LanguageHelper languageHelper) {
