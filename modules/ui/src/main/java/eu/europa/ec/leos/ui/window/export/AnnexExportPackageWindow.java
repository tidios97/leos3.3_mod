...
public class AnnexExportPackageWindow extends ExportPackageWindow {

    public AnnexExportPackageWindow(MessageHelper messageHelper, EventBus eventBus) {
        this(messageHelper, eventBus, null);
    }

    public AnnexExportPackageWindow(MessageHelper messageHelper, EventBus eventBus, ExportOptions exportOptions) {
