...
public abstract class ActionsMenuBarComponent extends MenuBar {
    ...
    public void setDropDownMenuItemDescription(String description) {
        mainMenuItem.setDescription(description);
    }
    ...
    protected MenuItem createMenuItemBefore(String caption, Resource icon, MenuBar.Command command, MenuItem itemToAddBefore) {
        MenuItem menuItem = mainMenuItem.addItemBefore(caption, icon, command, itemToAddBefore);
        menuItem.setStyleName("leos-actions-sub-menu-item");
        return menuItem;
    }
    ...
    protected MenuItem createCheckMenuItemBefore(String caption, Command command, MenuItem itemToAddBefore) {
        MenuItem menuItem = createMenuItemBefore(caption, LeosTheme.LEOS_CHECKBOX_16, command, itemToAddBefore);
        menuItem.setCheckable(true);
        return menuItem;
    }
}
