...
public class AbstractWindow extends Window {
    ...
    protected AbstractWindow(MessageHelper messageHelper, final EventBus eventBus) {
        this(messageHelper, eventBus, "leos.button.close");
    }

    protected AbstractWindow(MessageHelper messageHelper, final EventBus eventBus, String closeButtonLabel) {
    ...
    private HorizontalLayout buildButtonsArea() {
        ...
        if (hasCloseButton()) {
            Button closeButton = new Button(messageHelper.getMessage(closeButtonLabel));
