...
interface MemorandumScreen {
    ...
    void populateComparisonContent(String comparedContent, String comparedInfo, Memorandum original, Memorandum current);
    ...
    void setPermissions(DocumentVO memorandum, boolean isClonedProposal);

    void initLeosEditor(DocumentVO memorandum, List<LeosMetadata> documentsMetadata);

    void initAnnotations(DocumentVO memorandum, String proposalRef, String connectedEntity);
    ...
    void setDownloadStreamResourceForXmlFiles(Memorandum original, Memorandum intermediate, Memorandum current, String language, String comparedInfo,
