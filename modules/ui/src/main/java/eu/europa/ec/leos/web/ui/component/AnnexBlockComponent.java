...
public class AnnexBlockComponent extends VerticalLayout {
    ...
    public void populateData(DocumentVO annex) {
        ...
        String annexTitlePrefix = StringUtils.substringBefore(annex.getMetadata().getNumber(), " ");
        String annexTitleNumber = StringUtils.substringAfter(annex.getMetadata().getNumber(), " ");
        annexTitlePrefix = StringUtils.capitalize(annexTitlePrefix.toLowerCase());
        heading.setCaption(annexTitlePrefix + " " + annexTitleNumber);
