...
public class LayoutChangeRequestEvent {
    ...
    public LayoutChangeRequestEvent(@Nonnull ColumnPosition position, Class changedComponent, Component childComponent) {
    ...
    public Component getChildComponent() { return childComponent; }
