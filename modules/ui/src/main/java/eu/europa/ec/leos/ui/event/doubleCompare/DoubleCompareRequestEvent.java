...
public class DoubleCompareRequestEvent {
    private String originalProposalId;
    private String intermediateMajorId;
    private String currentId;

    public DoubleCompareRequestEvent(String originalProposalId, String intermediateMajorId, String currentId) {
    ...
    public String getIntermediateMajorId() {
        return intermediateMajorId;
    }
