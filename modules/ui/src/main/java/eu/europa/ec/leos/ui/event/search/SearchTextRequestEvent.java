...
public class SearchTextRequestEvent {

    public final Long searchID;
    public final String searchText;
    public final boolean matchCase;
    public final boolean completeWords;

    public SearchTextRequestEvent(Long searchID, String searchText, boolean matchCase, boolean completeWords) {
        super();
