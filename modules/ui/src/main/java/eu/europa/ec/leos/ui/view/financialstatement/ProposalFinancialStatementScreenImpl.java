...
public class ProposalFinancialStatementScreenImpl extends FinancialStatementScreenImpl {
    ...
    private MarkedTextComponent<FinancialStatement> markedTextComponent;
    ...
    @Autowired
    ProposalFinancialStatementScreenImpl(MessageHelper messageHelper, EventBus eventBus, SecurityContext securityContext, UserHelper userHelper,
    ...
    @Override
    public void populateDoubleComparisonContent(String comparedContent, String versionInfo, FinancialStatement original, FinancialStatement intermediate, FinancialStatement current) {
