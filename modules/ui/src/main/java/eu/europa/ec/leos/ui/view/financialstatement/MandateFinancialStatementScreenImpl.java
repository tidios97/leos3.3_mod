...
public class MandateFinancialStatementScreenImpl extends FinancialStatementScreenImpl {
    ...
    public void init() {
        ...
        new SoftActionsExtension<>(financialStatementContent);
    }
    ...
    @Override
    public void setDataFunctions(DocumentVO documentVO, List<VersionVO> allVersions,
        ...
        boolean canRestorePreviousVersion = securityContext.hasPermission(documentVO, LeosPermission.CAN_RESTORE_PREVIOUS_VERSION);
        boolean canDownload = securityContext.hasPermission(documentVO, LeosPermission.CAN_DOWNLOAD_XML_COMPARISON);
    ...
    public void setPermissions(DocumentVO documentVO, boolean isClonedProposal) {
        super.setPermissions(documentVO, isClonedProposal);
        boolean enableExportPackage = securityContext.hasPermission(documentVO, LeosPermission.CAN_WORK_WITH_EXPORT_PACKAGE);
