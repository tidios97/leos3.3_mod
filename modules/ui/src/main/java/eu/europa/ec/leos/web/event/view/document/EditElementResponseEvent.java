...
public class EditElementResponseEvent {
    ...
    private final LevelItemVO levelItemVO;
    private final boolean isCloneProposal;

    public EditElementResponseEvent(String elementId, String elementTagName, String elementFragment, String docType,
            User user, String[] permissions, String instanceType, String alternatives, LevelItemVO levelItemVO,
                                    boolean isCloneProposal) {
        ...
        this.isCloneProposal = isCloneProposal;
    }
