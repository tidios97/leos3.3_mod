...
public class EditBoxComponent extends CustomField<String> {
	...
	protected AbstractTextField editbox;
	...
	private boolean textAreaMode = false;

 public EditBoxComponent() {
     this(false);
 }
 
 public EditBoxComponent(boolean textAreaMode) {
     this.textAreaMode = textAreaMode;
     buildComponent();
     addListeners();
 }
	...
	private void buildComponent() {
		...
		if (textAreaMode) {
		    editbox = new TextArea();
		    ((TextArea)editbox).setRows(1);
		} else {
