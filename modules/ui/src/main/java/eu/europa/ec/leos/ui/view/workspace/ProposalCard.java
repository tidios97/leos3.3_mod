...
public class ProposalCard extends VerticalLayout {
    ...
    protected Label revisionStatus;
    ...
    private void initializeStaticData() {
        ...
        revisionStatus.setVisible(false);
    ...
    private void setData() {
        ...
        if(proposal.isClonedProposal()) {
            setClonedProposalLabels();
        }

        addStyleName("proposal");
    }

    private void setClonedProposalLabels() {
        revision.setValue(messageHelper.getMessage("clone.proposal.contribution.label"));
        revision.setVisible(true);
        revisionStatus.setCaption(messageHelper.getMessage("card.caption.contribution.status"));
        revisionStatus.setValue(proposal.getRevisionStatus());
        revisionStatus.setVisible(true);
        originRef.setValue(proposal.getOriginRef());
        originRef.setVisible(true);
        addStyleName("cloned-proposal");
    }
}