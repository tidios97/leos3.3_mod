...
abstract class WorkspaceScreenImpl extends HorizontalLayout implements WorkspaceScreen {
    ...
    protected Button createCouncilDocumentButton;
    ...
    private void initListeners() {
        ...
        this.addShortcutListener(new CtrlHomeListener("v-grid-scroller-vertical"));
        this.addShortcutListener(new CtrlEndListener("v-grid-scroller-vertical"));
    }
