...
abstract class MemorandumScreenImpl extends VerticalLayout implements MemorandumScreen {
    ...
    public void initSearchAndReplace() {
        searchDelegate = new SearchDelegate(searchButton, memorandumDoc, messageHelper, eventBus, memorandumContent, searchAndReplaceEnabled);
    }
    ...
    void init() {
        ...
        new ChangeDetailsExtension<>(memorandumContent, eventBus);
    ...
    public abstract void populateComparisonContent(String comparedContent, String versionInfo, Memorandum original, Memorandum current);
