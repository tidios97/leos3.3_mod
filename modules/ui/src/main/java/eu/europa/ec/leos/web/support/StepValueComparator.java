...
public class StepValueComparator implements Comparator<RangeSliderStepVO> {
     ...
     */
    @Override
    public int compare(RangeSliderStepVO version1, RangeSliderStepVO version2) {
        if (version1 == null || version2 == null) {
            return (version1 == null)
                    ? ((version2 == null) ? 0 : -1)
                    : 1; // version1 greater
        }
        String value1 = version1.getStepValue().replaceAll("[a-zA-Z]*", ""); //remove all Chars such as V etc
        String value2 = version2.getStepValue().replaceAll("[a-zA-Z]*", "");

        StringTokenizer st1 = new StringTokenizer(value1, ".", false);
        StringTokenizer st2 = new StringTokenizer(value2, ".", false);
