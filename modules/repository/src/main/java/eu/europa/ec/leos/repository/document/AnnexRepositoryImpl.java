...
public class AnnexRepositoryImpl implements AnnexRepository {
    ...
    public List<Annex> findAllMinorsForIntermediate(String docRef, String currIntVersion, int startIndex, int maxResults) {
        ...
        return leosRepository.findAllMinorsForIntermediate(Annex.class, docRef, currIntVersion, startIndex, maxResults);
    }
    ...
    public int findAllMinorsCountForIntermediate(String docRef, String currIntVersion) {
        ...
        return leosRepository.findAllMinorsCountForIntermediate(Annex.class, docRef, currIntVersion);
    }
    ...
    public Annex findFirstVersion(String documentRef) {
        return leosRepository.findFirstVersion(Annex.class, documentRef);
    }
}
