...
public class CmisSessionFactoryImpl implements CmisSessionFactory {
    ...
    @Value("${leos.cmis.repository.binding.read.timeout}")
    private String repositoryBindingReadTimeout;
    ...
    public Session createSession() {
        ...
        parameters.put(SessionParameter.READ_TIMEOUT, repositoryBindingReadTimeout);
