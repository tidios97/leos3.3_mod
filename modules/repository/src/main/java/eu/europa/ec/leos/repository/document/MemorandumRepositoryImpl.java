...
public class MemorandumRepositoryImpl implements MemorandumRepository {
    ...
    public List<Memorandum> findAllMinorsForIntermediate(String docRef, String currIntVersion, int startIndex, int maxResults) {
        ...
        return leosRepository.findAllMinorsForIntermediate(Memorandum.class, docRef, currIntVersion, startIndex, maxResults);
    }
    ...
    public int findAllMinorsCountForIntermediate(String docRef, String currIntVersion) {
        ...
        return leosRepository.findAllMinorsCountForIntermediate(Memorandum.class, docRef, currIntVersion);
    }
    ...
    @Override
    public Memorandum findFirstVersion(String ref) {
        return leosRepository.findFirstVersion(Memorandum.class, ref);
    }
}
