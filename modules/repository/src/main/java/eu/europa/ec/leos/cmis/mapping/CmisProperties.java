...
public enum CmisProperties {
    ...
    METADATA_EEA_RELEVANCE("metadata:eeaRelevance"),
    ...
    CLONED_PROPOSAL("leos:clonedProposal"),
    ORIGIN_REF("leos:originRef"),
    CLONED_FROM("leos:clonedFrom"),
    REVISION_STATUS("leos:revisionStatus"),
