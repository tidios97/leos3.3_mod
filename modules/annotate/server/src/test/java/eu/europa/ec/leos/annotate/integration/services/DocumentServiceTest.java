...
public class DocumentServiceTest {
    ...
    @Test
    @SuppressFBWarnings(value = SpotBugsAnnotations.KnownNullValue, justification = SpotBugsAnnotations.KnownNullValueReason)
    public void testCreateDocumentByInvalidUri() {
    ...
    /**
     * test that deleting an unknown document throws an exception
     */
    // New JPA repository version 2.6.4 not throws an exception when deleting a document
    // that does not exist. Method deleteDocument is only used in tests, not in real
    // application, then not needed to check and throw manually this CannotDeleteDocumentException exception
    @Test(expected = CannotDeleteDocumentException.class)
    @Ignore
    public void testDeleteUnknownDocument() throws CannotDeleteDocumentException {
