...
public class AnnotationAnonymisationTest {
    ...
    public void cleanDatabaseBeforeTests() {
        ...
        Mockito.when(userService.getUserDetailsFromUserRepo(Mockito.anyString(), Mockito.any())).thenReturn(details);
    ...
    public void testAnonymisationIscAnnotationSentLeosModels_noUserDetails() {
        ...
        Mockito.when(userService.getUserDetailsFromUserRepo(Mockito.anyString(), Mockito.any())).thenReturn(null);
    ...
    private Annotation createAnnotation(final String authority, final ResponseStatus respStatus) {
        ...
        if (respStatus == ResponseStatus.SENT) {
            ...
            meta.setResponseStatusUpdatedByUser(3L);
            meta.setResponseStatusUpdatedByGroup(4L);
        }
