...
public class AuthenticationServiceImplTest {
    ...
    public void test_getUserLogin() throws Exception {
        ...
        final UserInformation info = authenticationService.getUserLoginFromTokenWithContext(token1, null);
    ...
    @Test
    public void Test_getUserLogin_Ok() throws NoClientsAvailableException, TokenFromUnknownClientException, TokenInvalidForClientAuthorityException {
        ...
        // Actual call
        final UserInformation result = authenticationService.getUserLoginFromTokenWithContext(token, null);
    ...
    @Test
    public void Test_getUserLogin_twoClients_Ok()
    ...
    public void Test_getUserLogin_noMatchingClient()
            throws NoClientsAvailableException, TokenFromUnknownClientException, TokenInvalidForClientAuthorityException {
        ...
        authenticationService.getUserLoginFromTokenWithContext("whatevertoken", null);
    }

    // test retrieval of user login from given token, but fails as no clients are registered at all
    @Test(expected = NoClientsAvailableException.class)
    public void Test_getUserLogin_noClients()
            throws NoClientsAvailableException, TokenFromUnknownClientException, TokenInvalidForClientAuthorityException {
    ...
    public void test_getUserLogin_wrongAuthority() throws Exception {
        ...
        // actual call - should fail!
        authenticationService.getUserLoginFromTokenWithContext(token, null);
    }
    ...
    public void test_getUserLogin_authorityUndefined() throws Exception {
        ...
        final UserInformation info = authenticationService.getUserLoginFromTokenWithContext(token, null);
