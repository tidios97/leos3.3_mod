...
public class AnnotationRetrievalTest {
    ...
    public void testFindAnnotation() throws MissingPermissionException {
        ...
        userDetailsCache.cache(LOGIN, null, new UserDetails(LOGIN, Long.valueOf(4), "first", "last", 
        ...
        final Annotation ann = annotService.findAnnotationById(annot.getId(), LOGIN, null);
    ...
    public void testFindNonExistingAnnotation() throws CannotCreateAnnotationException, MissingPermissionException {
        ...
        // verification: search the annotation again based on its ID with the same user
        try {
            annotService.findAnnotationById(null, LOGIN, null);
        ...
        Assert.assertNull(annotService.findAnnotationById("myid", LOGIN, null));
    }
    ...
    public void testFindPrivateAnnotationOfOtherUser() throws MissingPermissionException, CannotCreateAnnotationException {
        ...
        final JsonAnnotation jsAnnot = TestData.getTestPrivateAnnotationObject(hypothesisUserAccount);
        ...
        annotService.findAnnotationById(annot.getId(), otherLogin, null); // should throw MissingPermissionException
    }
    ...
    public void testFindPublicAnnotationOfOtherUser() throws MissingPermissionException, CannotCreateAnnotationException {
        ...
        final Annotation annotRetrieved = annotService.findAnnotationById(annot.getId(), otherLogin, null);
        Assert.assertNotNull(annotRetrieved);
    }
