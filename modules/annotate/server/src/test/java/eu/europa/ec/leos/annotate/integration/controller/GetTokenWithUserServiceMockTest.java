...
public class GetTokenWithUserServiceMockTest {
 ...
 // -------------------------------------
    ...
    public void testGetToken_UserServiceThrowsExceptionsWhenCreatingUser() throws Exception {
        ...
        Mockito.when(userService.createUserIfNotExists(Mockito.anyString(), Mockito.anyString())).thenThrow(new RuntimeException());
        ...
        final AuthApiController controller = new AuthApiController(userService, authService, userGroupService);
        ...
        Assert.assertTrue(StringUtils.hasLength(jsResponse.getError()));
        Assert.assertTrue(StringUtils.hasLength(jsResponse.getError_description()));
    }
    ...
    public void testGetToken_UserServiceThrowsExceptionsWhenRetrievingUserDetails() throws Exception {
        ...
        Mockito.when(userService.getUserDetailsFromUserRepo(Mockito.anyString(), Mockito.anyString())).thenThrow(new RuntimeException());
