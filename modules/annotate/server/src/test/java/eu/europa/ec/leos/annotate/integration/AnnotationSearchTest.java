...
public class AnnotationSearchTest {
    ...
    public void cleanDatabaseBeforeTests() throws URISyntaxException {
        ...
        userRepos.saveAll(Arrays.asList(firstUser, secondUser));
        ...
        documentRepos.saveAll(Arrays.asList(firstDoc, secondDoc));
        ...
        metadataRepos.saveAll(Arrays.asList(firstMeta, secondMeta));
    ...
    public void testSearchDoesNotWorkWithoutOptions() {
        ...
        annotSearchService.searchAnnotations(null, firstUserInfo); // no Options supplied
    }
    ...
    public void testSearchDoesNotWorkWithoutLogin() {
        ...
        annotSearchService.searchAnnotations(options, null); // no user login supplied
    }
    ...
    public void testSearchGroupAndUri() {
        ...
        AnnotationSearchResult annots = annotSearchService.searchAnnotations(options, firstUserInfo);
        ...
        List<Annotation> replies = annotSearchService.searchRepliesForAnnotations(annots, options, firstUserInfo);
        assertAnnotationContained(replies, ID_PUBREPLY_USER1_DOC1);

        // run search for second user
        annots = annotSearchService.searchAnnotations(options, secondUserInfo);
        ...
        replies = annotSearchService.searchRepliesForAnnotations(annots, options, secondUserInfo);
        assertAnnotationContained(replies, ID_PUBREPLY_USER1_DOC1);
    ...
    public void testSearchGroupAndUriAndUser_firstUser_ownAnnots_firstDocument() {
        ...
        final AnnotationSearchResult annots = annotSearchService.searchAnnotations(options, firstUserInfo);
        final List<Annotation> replies = annotSearchService.searchRepliesForAnnotations(annots, options, firstUserInfo);
    ...
    public void testSearchGroupAndUriAndUser_secondUser_firstUserAnnots_firstDocument() {
        ...
        final AnnotationSearchResult annots = annotSearchService.searchAnnotations(options, secondUserInfo);
        final List<Annotation> replies = annotSearchService.searchRepliesForAnnotations(annots, options, secondUserInfo);
    ...
    // 4a) search from second user's perspective for his own annotations in first document
    // search is restricted to public annotations
    @Test
    public void testSearchGroupAndUriAndUser_secondUser_secondUserAnnots_firstDocument_sharedTrue() {
        ...
        // verify
        Assert.assertNotNull(annots);
        Assert.assertEquals(0, annots.size()); // no public annotation of this user
    }

    // 4b) search from second user's perspective for his own annotations in first document
    // search is restricted to private annotations
    @Test
    public void testSearchGroupAndUriAndUser_secondUser_secondUserAnnots_firstDocument_sharedFalse() {
    ...
    public void testSearchGroupAndUri_NegativeLimit_ProvideAll() {
        ...
        annots = annotSearchService.searchAnnotations(options, firstUserInfo);
        Assert.assertNotNull(annots);
        ...
        replies = annotSearchService.searchRepliesForAnnotations(annots, options, firstUserInfo);
        Assert.assertNotNull(replies);
    ...
    public void testSearchSeparateReplies() {
        ...
        jsrwsr.getRows().stream().allMatch(jsonAnnot -> !JsonAnnotationHandler.isReply(jsonAnnot));

        // check that the 'replies' contains replies
        jsrwsr.getReplies().stream().allMatch(jsonAnnot -> JsonAnnotationHandler.isReply(jsonAnnot));
    }
    ...
    public void testCannotSearchRepliesWithoutAnnotations() {
        ...
        Assert.assertNull(annotSearchService.searchRepliesForAnnotations(null, null, null));

        // annotations list empty -> empty list
        Assert.assertEquals(0, annotSearchService.searchRepliesForAnnotations(new AnnotationSearchResult(), null, null).size());
    }
    ...
    public void testCannotSearchRepliesWithoutSearchOptions() {
        ...
        annotSearchService.searchRepliesForAnnotations(dummy, null, null); // should throw IllegalArgumentException
    }
    ...
    public void testCannotSearchRepliesWithoutUserInfo() {
        ...
        annotSearchService.searchRepliesForAnnotations(dummy, options, null); // should throw IllegalArgumentException
    }
