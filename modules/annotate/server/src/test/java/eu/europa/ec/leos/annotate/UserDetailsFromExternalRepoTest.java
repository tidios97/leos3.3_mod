...
public class UserDetailsFromExternalRepoTest {
    ...
    public void testRestUdRepoCalls() {
        ...
        final UserService userService = new UserServiceImpl(restOperations, false);
        ...
        UserDetails result = userService.getUserDetailsFromUserRepo(login, null);
        ...
        userService.getUserDetailsFromUserRepo(login, null);
        ...
        result = userService.getUserDetailsFromUserRepo("anotheruser", null);
    ...
    public void testUserDisplayNameWithUdRepo() throws UserNotFoundException {
        ...
        userInfo.setConnectedEntity(userEntityName);
