...
public final class SerialisationHelper {
    ...
    public static String serializeMetadataAndStatus(final List<SimpleMetadata> requestedMetadata, final List<AnnotationStatus> statuses)
        ...
        if (StringUtils.hasLength(String.valueOf(statuses))) {
    ...
    // -------------------------------------
    public static JsonAnnotation deserializeJsonAnnotation(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonAnnotation.class);
    }

    public static JsonFailureResponse deserializeJsonFailureResponse(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonFailureResponse.class);
    }

    public static JsonResetSuccessResponse deserializeJsonResetSuccessResponse(final String input)
            throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonResetSuccessResponse.class);
    }

    public static JsonBulkResetSuccessResponse deserializeJsonBulkResetSuccessResponse(final String input)
            throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonBulkResetSuccessResponse.class);
    }

    public static JsonTreatSuccessResponse deserializeJsonTreatSuccessResponse(final String input)
            throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonTreatSuccessResponse.class);
    }
    ...
    public static JsonBulkTreatSuccessResponse deserializeJsonBulkTreatSuccessResponse(final String input)
            throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonBulkTreatSuccessResponse.class);
    }

    public static JsonSearchResult deserializeJsonSearchResult(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
    ...
    public static JsonTokenResponse deserializeJsonTokenResponse(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(input, JsonTokenResponse.class);
    }

    public static List<JsonGroupWithDetails> deserializeJsonGroupWithDetails(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
    ...
    public static JsonSearchCount deserializeJsonSearchCount(final String input) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
