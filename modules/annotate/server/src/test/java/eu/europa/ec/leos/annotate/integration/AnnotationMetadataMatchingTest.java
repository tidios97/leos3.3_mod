...
@ActiveProfiles("test")
@SuppressWarnings("PMD.TooManyMethods") // test classes for complex relations
public class AnnotationMetadataMatchingTest {
    ...
    public void cleanDatabaseBeforeTests() {
        ...
        annotService = new AnnotationServiceImpl(annotationTestRepository, annotPermService,
                groupService, userGroupService, tagsService,
                metadataService, metadataMatchingService, uuidService, userService, documentService);
    }
    ...
    private void runTestIscUserIsc_SearchForGroupOnly_StatusCombinations(final List<AnnotationStatus> statuses,
            final List<Annotation> expectedAnnots) {
        ...
        annotationTestRepository.saveAll(Arrays.asList(ann2, ann3, ann4, ann5));
    ...
    public void testIscUserIsc_SearchForGroupOnly_ReplyDeletedStatus() throws Exception {
        ...
        annotationTestRepository.deleteAll(Arrays.asList(ann5, ann6, ann7));
        ...
        annotationTestRepository.saveAll(Arrays.asList(ann2, ann2Reply));
        ...
        annotationTestRepository.save(ann3Reply);
        ...
        annotationTestRepository.save(ann4);

        setMetadataSent(Arrays.asList(ann1, ann2, ann3, ann4, ann5, ann6, ann7)); // all are SENT, could be found
        
        // act
        // no metadata sent -> all annotations should match; status NORMAL -> two matches, and one of its replies
        AnnotationSearchOptionsHandler.setStatuses(options, Arrays.asList(AnnotationStatus.NORMAL));
        AnnotationSearchResult result = annotSearchService.searchAnnotations(options, userInfo);
        ...
        AnnotationSearchOptionsHandler.setStatuses(options, Arrays.asList(AnnotationStatus.DELETED));
        result = annotSearchService.searchAnnotations(options, userInfo);
        ...
        AnnotationSearchOptionsHandler.setStatuses(options, Arrays.asList(AnnotationStatus.NORMAL, AnnotationStatus.DELETED));
        result = annotSearchService.searchAnnotations(options, userInfo);
        checkResult(result, Arrays.asList(ann1, ann2, ann3, ann4));
        replies = annotSearchService.searchRepliesForAnnotations(result, options, userInfo);
        Assert.assertEquals(4, replies.size());
        MatcherAssert.assertThat(Arrays.asList(ann1Reply.getId(), ann2Reply.getId(), ann3Reply.getId(), ann4Reply.getId()),
    ...
    private AnnotationSearchResult runSearchForIscRef1Only() {
        ...
        return annotSearchService.searchAnnotations(options, userInfo);
    }
    ...
    private AnnotationSearchResult runSearchForIscRef2Only() {
    ...
    private AnnotationSearchResult runSearchForRespVers1Only() {
    ...
    private AnnotationSearchResult runSearchForRespVers2Only() {
    ...
    private AnnotationSearchResult runSearchForIscRef1RespVers1() {
    ...
    private AnnotationSearchResult runSearchForIscRef1RespVers2() {
    ...
    private AnnotationSearchResult runSearchForIscRef2RespVers1() {
    ...
    private AnnotationSearchResult runSearchForIscRef2RespVers2() {
    ...
    private AnnotationSearchResult runSearchForIscRef1Ref2() {
    ...
    private AnnotationSearchResult runSearchForIscRef1Version1And2() {
    ...
    private AnnotationSearchResult runSearchForIscRef1Version1Ref2Version2() {
    ...
    public void testIscUserIsc_SearchForRespVers2AndSent_OneDeleted() throws Exception {
        ...
        annotationTestRepository.save(ann5);
    ...
    private AnnotationSearchResult runSearchForRespVers2AndSent(final Optional<List<AnnotationStatus>> statusesToSet) {
    ...
    private AnnotationSearchResult runSearchForIscRef2Vers1AndVers3AndUnknownRef() {
    ...
    private AnnotationSearchResult runSearchForUnknownIscRef() {
    ...
    private AnnotationSearchResult runSearchForResponseStatusSent() {
    ...
    private AnnotationSearchResult runSearchForIscRef1ResponseStatusSent() {
    ...
    private AnnotationSearchResult runSearchForIscRef2ResponseStatusSent() {
    ...
    private AnnotationSearchResult runSearchForIscRef1InSecondGroup() {
