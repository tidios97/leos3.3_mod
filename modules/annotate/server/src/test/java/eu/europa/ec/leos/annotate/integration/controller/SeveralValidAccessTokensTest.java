...
public class SeveralValidAccessTokensTest {
    ...
    public void testSearchAnnotationsWithSeparateReplies() throws Exception {
        ...
        final JsonAnnotation jsAnnotFirst = TestData.getTestPrivateAnnotationObject(USER1);
        final Annotation annotFirst = annotService.createAnnotation(jsAnnotFirst, userInfo1_token1);
        ...
        final String uri = annotFirst.getDocument().getUri().toString();
