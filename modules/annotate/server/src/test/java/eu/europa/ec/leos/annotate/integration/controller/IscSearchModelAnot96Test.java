...
public class IscSearchModelAnot96Test {
    ...
    private void createTestData() {
        ...
        groupRepos.saveAll(Arrays.asList(groupDigit, groupAgri, groupSg));
        ...
        userRepos.saveAll(Arrays.asList(digitWorldUser, agriWorldUser, sgWorldUser));
        ...
        userDetailsCache.cache(digitWorldUser.getLogin(), null, new UserDetails(digitWorldUser.getLogin(), Long.valueOf(2), DIGIT, "user2", entitiesDigit, "", null));
        userDetailsCache.cache(agriWorldUser.getLogin(), null, new UserDetails(agriWorldUser.getLogin(), Long.valueOf(3), AGRI, "user3", entitiesAgri, "", null));
        userDetailsCache.cache(sgWorldUser.getLogin(), null, new UserDetails(sgWorldUser.getLogin(), Long.valueOf(4), "sg", "user4", entitiesSg, "", null));
        ...
        metaHelpSentV1.put(Metadata.PROP_RESPONSE_STATUS, ResponseStatus.SENT.toString());

        final Metadata metaSentAgriV1 = new Metadata(document, groupAgri, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentAgriV1, metaHelpSentV1);
        ...
        metaHelpSentV2.put(Metadata.PROP_RESPONSE_STATUS, ResponseStatus.SENT.toString());

        final Metadata metaSentAgriV2 = new Metadata(document, groupAgri, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentAgriV2, metaHelpSentV2);
        addResponseId(metaSentAgriV2, AGRI);
        metadataRepos.save(metaSentAgriV2);
        createAnnotation(ANNOT_B, agriWorldUser, metaSentAgriV2);

        // for C:
        final Metadata metaSentDigitV1 = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentDigitV1, metaHelpSentV1);
        ...
        final Metadata metaSentDigitV1SentDeletedDeleted = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentDigitV1SentDeletedDeleted, metaHelpSentV1);
        ...
        // for E:
        final Metadata metaSentDigitV2Linked = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentDigitV2Linked, metaHelpSentV2);
        ...
        // for F:
        @SuppressWarnings("PMD.LongVariable")
        final Metadata metaSentDigitV2SentDeleted = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaSentDigitV2SentDeleted, metaHelpSentV2);
        ...
        metaHelpInPrepV3.put(Metadata.PROP_RESPONSE_STATUS, ResponseStatus.IN_PREPARATION.toString());
        final Metadata metaInPrepDigitV3Linked = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaInPrepDigitV3Linked, metaHelpInPrepV3);
        ...
        // for H:
        final Metadata metaInPrepDigitV3 = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaInPrepDigitV3, metaHelpInPrepV3);
        metadataRepos.save(metaInPrepDigitV3);
        createAnnotation(ANNOT_H, digitWorldUser, metaInPrepDigitV3);

        // for I:
        final Metadata metaInPrepAgriV3 = new Metadata(document, groupAgri, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaInPrepAgriV3, metaHelpInPrepV3);
    ...
    private void addResponseId(final Metadata meta, final String respId) {
        ...
        final SimpleMetadata kvPairs = MetadataHandler.getKeyValuePropertyAsSimpleMetadata(meta);
    ...
    public void count_Sg_Sg() {
        ...
        final Annotation refAnnot = annotRepos.findById(ANNOT_C).get();
