...
public class GetAnnotationTest {
    ...
    public void testGetAnnotationOk() throws Exception {
        ...
        final Annotation annot = annotService.createAnnotation(jsAnnot, new UserInformation(userToken));
    ...
    public void testGetAnnotationFailureNotFound() throws Exception {
        ...
        final JsonAnnotation jsAnnot = TestData.getTestAnnotationObject(hypothesisUserAccount);
        final Annotation annot = annotService.createAnnotation(jsAnnot, new UserInformation(user, Authorities.ISC));
        final String annotId = annot.getId().substring(1); // get ID, but cut beginning
