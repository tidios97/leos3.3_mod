...
public class SuggestionRejectTest {
    ...
    public void testRejectSimpleSuggestion() throws Exception {
        ...
        annotSuggestionService.rejectSuggestionById(annot.getId(), userInfo);
        ...
        Assert.assertEquals(1, documentRepos.count());
        Assert.assertEquals(1, tagRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.REJECTED, theUser.getId(), null);
    ...
    public void testRejectSuggestionInLeos() throws Exception {
        ...
        Assert.assertEquals(1, documentRepos.count());
        Assert.assertEquals(1, tagRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.REJECTED, userInfo.getUser().getId(), null);
    }
    ...
    public void testRejectSimpleSuggestionWithReply() throws Exception {
        ...
        final JsonAnnotation jsReply = TestData.getTestReplyToAnnotation(hypothesisUserAccount, new URI(annot.getDocument().getUri()),
        ...
        Assert.assertEquals(1, documentRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.REJECTED, theUser.getId(), null);
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.REJECTED, theUser.getId(), null);
    }
    ...
    public void testUndefinedSuggestionId() throws Exception {
        ...
        final UserInformation userInfo = new UserInformation(theUser, Authorities.ISC);
        annotSuggestionService.rejectSuggestionById(null, userInfo);
    ...
    public void testSuggestionNotFound() throws Exception {
        ...
        final UserInformation userInfo = new UserInformation(theUser, Authorities.ISC);
        annotSuggestionService.rejectSuggestionById("suggestionId", userInfo);
    ...
    public void testRejectSuggestionWithoutUserLogin() throws Exception {
        ...
        annotSuggestionService.rejectSuggestionById(annot.getId(), null);
    ...
    public void testRejectSuggestionWithUserNotBeingGroupMember() throws Exception {
        ...
        annotSuggestionService.rejectSuggestionById(annot.getId(), userInfo); // should work
