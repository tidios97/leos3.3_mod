...
public class ResolvedSearchOptionsTest {
    ...
    public void testMetadataConversionFails_missingQuote() {
        ...
        final List<SimpleMetadataWithStatuses> deserial = JsonStringDeserializer.convertJsonToSimpleMetadataWithStatusesList(metaAsJson);
    ...
    public void testSetAllStatus() {
        ...
        Assert.assertEquals(1, rso.getMetadataWithStatusesList().size());
        MatcherAssert.assertThat(rso.getMetadataWithStatusesList().get(0).getStatuses(),
                org.hamcrest.Matchers.containsInAnyOrder(AnnotationStatus.NORMAL, AnnotationStatus.ACCEPTED, AnnotationStatus.REJECTED, AnnotationStatus.DELETED, AnnotationStatus.TREATED));
    }
