...
public class AuthenticationServiceTest {
    ...
    */
    ...
    public void testTokensAreGenerated() throws CannotStoreTokenException {
        ...
        Assert.assertTrue(StringUtils.hasLength(newTokens.getAccessToken()));
        Assert.assertTrue(StringUtils.hasLength(newTokens.getRefreshToken()));
    ...
    public void testFindUserByAccessToken_UnknownToken() {
        ...
        Assert.assertFalse(StringUtils.hasLength(userInfo.getLogin()));
    }
    ...
    public void testFindUserByAccessToken_ExpiredToken() {
        ...
        Assert.assertTrue(TokenHandler.isAccessTokenExpired(foundUser.getCurrentToken()));
    ...
    public void testFindUserByRefreshToken_ExpiredToken() {
        ...
        Assert.assertNotNull(foundUser);
        Assert.assertNotNull(foundUser.getCurrentToken());
        Assert.assertTrue(TokenHandler.isRefreshTokenExpired(foundUser.getCurrentToken()));
    }
    ...
    public void testFindUserByAccessToken() {
        ...
        Assert.assertFalse(TokenHandler.isAccessTokenExpired(foundUser.getCurrentToken()));
    }
    ...
    public void testFindUserByRefreshToken() {
        ...
        Assert.assertFalse(TokenHandler.isRefreshTokenExpired(foundUser.getCurrentToken()));
    }
