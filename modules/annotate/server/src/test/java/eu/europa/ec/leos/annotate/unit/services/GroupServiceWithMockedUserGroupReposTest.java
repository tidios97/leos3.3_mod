...
public class GroupServiceWithMockedUserGroupReposTest {
    ...
    public void testNoGroupsForUser() {
        ...
        Assert.assertNull(userGroupService.getGroupsOfUser(unknownUser));

        // and returns null for same as Json
        Assert.assertNull(userGroupService.getUserGroupsAsJson(new UserInformation(unknownUser, "someauthority")));
    }
    ...
    public void testNoUserIdsForUnknownGroup() {
        ...
        Assert.assertNull(userGroupService.getUserIdsOfGroup(unknownGroup));
    }
    ...
    public void testNoGroupIdsForUnknownUser() {
        ...
        Assert.assertNull(userGroupService.getGroupIdsOfUser(unknownUser));
    }
