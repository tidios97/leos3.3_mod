...
public class SearchModelTest {
    ...
    private final Consumer<SimpleMetadata> setResponseSent = hashMap -> hashMap.put(Metadata.PROP_RESPONSE_STATUS, ResponseStatus.SENT.toString());
    private final Consumer<SimpleMetadata> setResponseInPreparation = hashMap -> hashMap.put(Metadata.PROP_RESPONSE_STATUS, ResponseStatus.IN_PREPARATION.toString());
    ...
    private void createTestData() throws URISyntaxException {
        ...
        groupRepos.saveAll(Arrays.asList(groupDigit, groupAgri, groupSg, groupEnv));
        ...
        userRepos.saveAll(Arrays.asList(worldUser, digitWorldUser, agriWorldUser, agriDigitUser, sgWorldUser, envWorldSgUser));
        ...
        userDetailsCache.cache(worldUser.getLogin(), null, new UserDetails(worldUser.getLogin(), Long.valueOf(1), "world", "user1", entitiesWorld, "", AUTHOR_ROLE));
        userDetailsCache.cache(digitWorldUser.getLogin(), null, new UserDetails(digitWorldUser.getLogin(), Long.valueOf(2), DIGIT, "user2", entitiesDigit, "", AUTHOR_ROLE));
        userDetailsCache.cache(agriWorldUser.getLogin(), null, new UserDetails(agriWorldUser.getLogin(), Long.valueOf(3), AGRI, "user3", entitiesAgri, "", AUTHOR_ROLE));
        userDetailsCache.cache(sgWorldUser.getLogin(), null, new UserDetails(sgWorldUser.getLogin(), Long.valueOf(4), "sg", "user4", entitiesSg, "", AUTHOR_ROLE));
        userDetailsCache.cache(envWorldSgUser.getLogin(), null, new UserDetails(envWorldSgUser.getLogin(), Long.valueOf(5), ENV, "user5", entitiesEnv, "", AUTHOR_ROLE));
        userDetailsCache.cache(agriDigitUser.getLogin(), null, new UserDetails(agriDigitUser.getLogin(), Long.valueOf(6), AGRI, "user6", entitiesAgri, "", AUTHOR_ROLE));
        ...
        final Metadata metaLeosWorld = new Metadata(document, groupWorld, Authorities.EdiT);
        final Metadata metaLeosDigit = new Metadata(document, groupDigit, Authorities.EdiT);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaLeosDigit, getHashMapSentVers1());
        final Metadata metaLeosAgri = new Metadata(document, groupAgri, Authorities.EdiT);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaLeosAgri, getHashMapInPrepVers2());
        final Metadata metaLeosEnv = new Metadata(document, groupEnv, Authorities.EdiT);
        final Metadata metaLeosSg = new Metadata(document, groupSg, Authorities.EdiT);
        metadataRepos.saveAll(Arrays.asList(metaLeosWorld, metaLeosDigit, metaLeosAgri, metaLeosEnv, metaLeosSg));
        ...
        final Metadata metaIscDigit = new Metadata(document, groupDigit, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaIscDigit, getHashMapSentVers1());
        final Metadata metaIscSg = new Metadata(document, groupSg, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaIscSg, getHashMapSentVers2());
        final Metadata metaIscAgri = new Metadata(document, groupAgri, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaIscAgri, getHashMapInPrepVers1());
        final Metadata metaIscEnv = new Metadata(document, groupEnv, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaIscEnv, getHashMapSentVers1());
        final Metadata metaIscWorld = new Metadata(document, groupWorld, Authorities.ISC);
        MetadataHandler.setKeyValuePropertyFromSimpleMetadata(metaIscWorld, getHashMapInPrepVers2());
        metadataRepos.saveAll(Arrays.asList(metaIscDigit, metaIscSg, metaIscAgri, metaIscEnv, metaIscWorld));
