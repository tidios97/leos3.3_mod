...
public class AnnotationConversionServiceTest {
    ...
    @After
    public void closeServiceMocks() throws Exception {
        mocks.close();
    }
    ...
    public void testConvertAnnotationWithInvalidUri() {
        ...
        final JsonAnnotation converted = conversionService.convertToJsonAnnotation(annot, new UserInformation(login, null, Authorities.EdiT));
