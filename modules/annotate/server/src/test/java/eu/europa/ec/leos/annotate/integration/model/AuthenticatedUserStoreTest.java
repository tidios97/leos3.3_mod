 ...
 */
package eu.europa.ec.leos.annotate.integration.model;
...
public class AuthenticatedUserStoreTest {
 ...
 // -------------------------------------
    ...
    // -------------------------------------
    @Test
    public void testAuthenticatedUserStore() {

        // initially: empty
        Assert.assertNull(authUserStore.getUserInfo());

        // store a user
        final UserInformation authenticated = new UserInformation("login", null, "authority");
