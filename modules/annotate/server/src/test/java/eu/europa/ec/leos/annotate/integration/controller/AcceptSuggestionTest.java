...
public class AcceptSuggestionTest {
    ...
    public void testAcceptSuggestionOk() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annotId, AnnotationStatus.ACCEPTED, user.getId(), null);
    }
    ...
    /**
     * try accepting an existing suggestion: user may accept it although he is not member of the group
     * in which the annotation is posted (changed with ANOT-135)
     * expected HTTP 200
     */
    @SuppressFBWarnings(value = SpotBugsAnnotations.FieldNotInitialized, justification = SpotBugsAnnotations.FieldNotInitializedReason)
    @Test
    public void testAcceptSuggestionOkForNonGroupMembers() throws Exception {
        ...
        // the annotation was "accepted"
        Assert.assertEquals(1, annotRepos.count());
        TestHelper.assertHasStatus(annotRepos, annotId, AnnotationStatus.ACCEPTED, secondUser.getId(), null);
    }
}
