...
public class UpdateProfileTest {
    ...
    public void testUpdateProfileOk() throws Exception {
        ...
        final User user = new User(login, null, false); // pretend sidebar tutorial was not yet dismissed
        userRepos.save(user);
        ...
        Assert.assertTrue(userRepos.findByLoginAndContext(login, null).isSidebarTutorialDismissed());
    }
