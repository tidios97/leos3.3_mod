 ...
 */
package eu.europa.ec.leos.annotate.integration.model.web.helper;
...
public class JsonStringDeserializerTest {
    ...
    public void deserializeOneStatus() {
        ...
        final List<AnnotationStatus> result = JsonStringDeserializer.convertJsonToAnnotationStatusList(input);
        Assert.assertNotNull(result);
        Assert.assertEquals(1, result.size());
        MatcherAssert.assertThat(result, contains(AnnotationStatus.DELETED));
    }
    ...
    public void deserializeAllStatus() {
        ...
        MatcherAssert.assertThat(result,
                containsInAnyOrder(AnnotationStatus.NORMAL, AnnotationStatus.ACCEPTED, AnnotationStatus.REJECTED, AnnotationStatus.DELETED, AnnotationStatus.TREATED));
    }

    @Test
    public void deserializeAllStatusesIndividually() {

        final String input = "[\"NORMAL\", \"ACCEPTED\", \"REJECTED\", \"DELETED\", \"TREATED\"]";
    ...
    public void deserializeEmptyStatusList() {
        ...
        Assert.assertNotNull(result);
        Assert.assertEquals(1, result.size());
        MatcherAssert.assertThat(result, contains(AnnotationStatus.NORMAL));
    }
    ...
    public void deserializeListOfSimpleMetadataWithStatuses() {
        ...
        final List<SimpleMetadataWithStatuses> list = JsonStringDeserializer.convertJsonToSimpleMetadataWithStatusesList(SOURCE_JSON);
        ...
        MatcherAssert.assertThat(stats, containsInAnyOrder(AnnotationStatus.ACCEPTED, AnnotationStatus.DELETED));
    ...
    public void deserializeListOfSimpleMetadataWithStatuses_withoutQuotes() {
        ...
        Assert.assertEquals(2, stats.size());
        MatcherAssert.assertThat(stats, containsInAnyOrder(AnnotationStatus.ACCEPTED, AnnotationStatus.REJECTED));
    ...
    public void deserializeListOfSimpleMetadataWithStatuses_allStatus() {
        ...
        MatcherAssert.assertThat(stats,
                containsInAnyOrder(AnnotationStatus.NORMAL, AnnotationStatus.ACCEPTED, AnnotationStatus.REJECTED, AnnotationStatus.DELETED, AnnotationStatus.TREATED));
    ...
    public void deserializeListOfSimpleMetadataWithStatuses_noMetadata() {
        ...
        final List<AnnotationStatus> stats = list.get(0).getStatuses();
        Assert.assertEquals(2, stats.size());
        MatcherAssert.assertThat(stats, contains(AnnotationStatus.DELETED, AnnotationStatus.ACCEPTED));
    ...
    public void deserializeListOfSimpleMetadataWithStatuses_empty() {
        ...
        final List<AnnotationStatus> stats = list.get(0).getStatuses();
        Assert.assertEquals(1, stats.size());
        MatcherAssert.assertThat(stats, contains(AnnotationStatus.NORMAL));
