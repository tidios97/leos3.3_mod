...
public class AnnotationSearchSeveralGroupsTest {
    ...
    public void cleanDatabaseBeforeTests() throws URISyntaxException {
        ...
        groupRepos.saveAll(Arrays.asList(groupA, groupB));
        ...
        metadataRepos.saveAll(Arrays.asList(worldMeta, groupAMeta, groupBMeta));
    ...
    public void testSearchThirdUserGroupA() {
        ...
        try {
            annots = annotSearchService.searchAnnotations(options, thirdUserInfo);
            replies = annotSearchService.searchRepliesForAnnotations(annots, options, thirdUserInfo);
        } catch (Exception e) {
            Assert.fail("Unexpected exception received: " + e);
        }
        Assert.assertNotNull(annots);
