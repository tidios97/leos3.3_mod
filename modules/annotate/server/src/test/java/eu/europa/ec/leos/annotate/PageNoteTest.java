...
public class PageNoteTest {
    ...
    public void testUpdatePageNote()
        ...
        jsAnnotCreated.setText(updatedText);
        final Annotation annotUpdated = annotService.updateAnnotation(annotId, jsAnnotCreated, userInfo);

        // read annotation from database and verify that target remains "null"
        final Annotation readAnnot = annotService.findAnnotationById(annotUpdated.getId());
        Assert.assertNotNull(readAnnot);
    ...
    public void testDeletePageNote()
            ...
            CannotDeleteSentAnnotationException {
        ...
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.DELETED, user.getId(), null);
    }
    ...
    public void testSearchPageNote() throws CannotCreateAnnotationException {
        ...
        // delete the annotation
        final AnnotationSearchOptions options = new AnnotationSearchOptions(annot.getDocument().getUri(), "__world__", false, 200, 0, "asc", "created");
