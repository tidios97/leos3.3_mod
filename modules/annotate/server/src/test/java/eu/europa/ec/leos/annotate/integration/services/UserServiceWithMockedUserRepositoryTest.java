...
public class UserServiceWithMockedUserRepositoryTest {
    ...
    public void setupTests() {
        ...
        // manual creation of UserService instance since we cannot use the @InjectMocks annotation
        // when the constructor has @Value items injected; alternative is to create a dedicated
        // service for configurable values
        userService = new UserServiceImpl(userRepos, groupService, userGroupService, false);
    ...
    public void testAddingUserToEntityGroupThrowsExceptionInternally() throws GroupAlreadyExistingException {
        ...
        Assert.assertFalse(userGroupService.addUserToEntityGroup(new UserInformation(evilUser, details, null)));
    }
}
