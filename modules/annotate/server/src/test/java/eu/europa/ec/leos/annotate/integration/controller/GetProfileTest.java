...
public class GetProfileTest {
    ...
    public void testGetProfileOk() throws Exception {
        ...
        final User theUser = new User(login, null, true); // pretend sidebar tutorial was dismissed
        ...
        final MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/api/profile?authority=" + authority + "&connectedEntity=" + defaultGroup.getName())
    ...
    public void testGetProfileFailure() throws Exception {
        ...
        Assert.assertFalse(jsResponse.getError().isEmpty());
        Assert.assertFalse(jsResponse.getError_description().isEmpty());
    }
}
