...
public class AnnotationDeleteWithMockTest {
    ...
    public void testDeleteAnnotation_ReposFailure() throws Exception {
        ...
        final UserInformation userInfo = new UserInformation(login, null, Authorities.EdiT);
        ...
        Mockito.when(annotRepos.findById(annot.getId())).thenReturn(Optional.of(annot));
