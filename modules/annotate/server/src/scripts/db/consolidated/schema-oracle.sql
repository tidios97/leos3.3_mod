...
--
-- last modified 15.07.2022/ANOT-349
------------------------------------
...
CREATE TABLE "ANNOTATIONS" (
  ...
  "IS_FORWARDED" NUMBER(1,0) DEFAULT 0 NOT NULL ENABLE,
...
LOB ("JUSTIFICATION_TEXT") STORE AS BASICFILE;
LOB ("FORWARD_JUSTIFICATION") STORE AS BASICFILE;
