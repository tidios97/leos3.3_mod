...
CREATE TABLE IF NOT EXISTS USERS (
  ...
  CONSTRAINT "USERS_UK_LOGIN_CONTEXT" UNIQUE ("LOGIN", "CONTEXT")
);
...
CREATE TABLE IF NOT EXISTS METADATA (
  ...
  RESPONSE_STATUS_UPDATED_BY_USR   NUMBER,
  RESPONSE_STATUS_UPDATED_BY_GRP   NUMBER,
...
COMMENT ON COLUMN "METADATA"."RESPONSE_STATUS_UPDATED_BY_USR" IS 'User id of user that changed response status';
...
CREATE TABLE IF NOT EXISTS ANNOTATIONS (
  ...
  STATUS_UPDATED_BY_USER           NUMBER,
  STATUS_UPDATED_BY_GROUP          NUMBER,
  ...
  CONSTRAINT "ANNOTATIONS_FK_GROUPS" FOREIGN KEY ("CONNECTED_ENTITY_ID") REFERENCES "GROUPS" ("GROUP_ID") ON DELETE CASCADE
);
...
COMMENT ON COLUMN "ANNOTATIONS"."STATUS_UPDATED_BY_USER" IS 'User id of user that changed status';
