...
/**
 * Exception thrown when the default user group is required, but cannot be found in the database
 *
 */
public class DefaultGroupNotFoundException extends Exception {
