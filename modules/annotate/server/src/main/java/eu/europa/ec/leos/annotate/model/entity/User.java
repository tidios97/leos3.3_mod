 ...
 */
@Entity
@Table(name = "USERS", uniqueConstraints = @UniqueConstraint(columnNames = {"LOGIN", "CONTEXT"}))
...
public class User {
    ...
    public User(final String login, final String context) {
        this.login = login;
        this.context = context;
    }

    public User(final String login, final String context, final boolean tutorialDismissed) {
        this.login = login;
        this.context = context;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, login, context, sidebarTutorialDismissed);
    }
