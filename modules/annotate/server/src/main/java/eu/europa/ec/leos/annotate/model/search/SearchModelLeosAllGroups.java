...
/**
 * Search model class for search model LEOS.1: search for LEOS system with public group, including ISC system annotations
 * 
 * note: meanwhile, this class is identical to its base class; could be combined once search model development has settled
 */
public class SearchModelLeosAllGroups extends SearchModel {
