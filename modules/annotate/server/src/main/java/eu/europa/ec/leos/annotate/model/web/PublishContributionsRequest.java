...
public class PublishContributionsRequest {
    ...
    public PublishContributionsRequest(final String docUri, final String group,
            final String userId, final String iscRef, final String responseVersion) {
    ...
    @Generated
    public void setResponseVersion(final String respVers) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(docUri, group, userId, iscReference, responseVersion);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(this.docUri, other.docUri) &&
                ...
                Objects.equals(this.responseVersion, other.responseVersion);
    }
}
