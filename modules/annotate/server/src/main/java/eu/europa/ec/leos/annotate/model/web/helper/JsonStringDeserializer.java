...
public final class JsonStringDeserializer {

    private final static Logger LOG = LoggerFactory.getLogger(JsonStringDeserializer.class);
    ...
    public static List<SimpleMetadataWithStatuses> convertJsonToSimpleMetadataWithStatusesList(final String dataAsJson) {
        ...
        List<SimpleMetadataWithStatuses> map = new ArrayList<>();
        if (!StringUtils.hasLength(dataAsJson)) {
            return map;
        }
