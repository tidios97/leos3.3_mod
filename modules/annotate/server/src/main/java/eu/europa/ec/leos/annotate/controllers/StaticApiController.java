...
public class StaticApiController {
    ...
    @ResponseBody
    public String getApi(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
    ...
    @ResponseBody
    public String getLinks(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
