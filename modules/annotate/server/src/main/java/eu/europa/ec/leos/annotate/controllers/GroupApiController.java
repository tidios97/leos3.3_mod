...
public class GroupApiController {
     ...
     * @param documentUri (currently ignored) the URI of the document, used for scoped groups that only apply to certain URLs
    ...
    public ResponseEntity<Object> getGroups(final HttpServletRequest request, final HttpServletResponse response,
        ...
        List<JsonGroupWithDetails> groups;
        String errorMsg = "";
        ...
        try {
            ...
            groups = userGroupService.getUserGroupsAsJson(userInfo);
