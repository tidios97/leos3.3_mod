 ...
 * note: currently more or less a black box for us except for the "forward_annotations" setting
 */
...
public class JsonClientFeatures {
    ...
    private boolean forward_annotations = false; // only 'really used' property at the moment
    ...
    public JsonClientFeatures(final boolean forwardAnnotationsEnabled) {
        this.forward_annotations = forwardAnnotationsEnabled;
    }
    ...
    @Generated
    public boolean isForward_annotations() {
        return forward_annotations;
    }
    
    @Generated
    public void setForward_annotations(final boolean canForward) {
        this.forward_annotations = canForward;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(this.defer_realtime_updates, other.defer_realtime_updates) &&
                ...
                Objects.equals(this.forward_annotations, other.forward_annotations);
    }
}
