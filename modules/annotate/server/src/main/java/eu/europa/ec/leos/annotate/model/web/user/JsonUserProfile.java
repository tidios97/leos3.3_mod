...
public class JsonUserProfile {
    ...
    public JsonUserProfile() {
        ...
        this.features = new JsonClientFeatures(false);
        this.flash = new JsonFlash();
        this.groups = new ArrayList<>();
        this.user_info = new JsonUserInfo();
    }

    public JsonUserProfile(final boolean forwardAnnotationsEnabled) {

        this.features = new JsonClientFeatures(forwardAnnotationsEnabled);
        this.flash = new JsonFlash();
        this.groups = new ArrayList<>();
        this.user_info = new JsonUserInfo();
    }
