...
public class StatusApiController {
     ...
     * @param migrateVersion (request parameter)
     *        boolean flag indicating if the existing answer matching the other criteria is to change version
     *
     * @return
     ...
     *        details on which document/group the annotations are in, which user, ISC reference and response version are affected
     * @return
