...
public class UserInformation {
    ...
    private String context;           // the user's context
    ...
    // Constructors
    // -----------------------------------------------------------
    public UserInformation(final String login, final String context, final String authority) {
        this.login = login;
    ...
    public UserInformation(final Token token) {
        ...
        if (token != null) {
            ...
            this.context = this.user.getContext();
        }
    }
    ...
    public UserInformation(final User user, final UserDetails userDetails, final String context) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(login, context, authority, currentToken, user, userDetails, connectedEntity, searchUser);
    }
