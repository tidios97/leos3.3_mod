...
public class AuthApiController {
    ...
    public ResponseEntity<Object> getToken(final HttpServletRequest request, final HttpServletResponse response) {
    ...
    private UserInformation populateUserInfo(final HttpServletRequest request)
            throws NoClientsAvailableException, TokenFromUnknownClientException, TokenInvalidForClientAuthorityException {

        final UserInformation userInfo = authService.getUserLoginFromTokenWithContext(request.getParameter(BEARER_PARAMETER),
    ...
    private String getRequestContext(final HttpServletRequest request) {
        ...
        if (userService.isContextEnabled()) {
            return request.getParameter(CONTEXT_PARAMETER);
        }
    ...
    private Pair<Token, JsonAuthenticationFailure> getAccessToken(final HttpServletRequest request)
            throws CannotStoreTokenException, NoClientsAvailableException, TokenFromUnknownClientException, TokenInvalidForClientAuthorityException {
