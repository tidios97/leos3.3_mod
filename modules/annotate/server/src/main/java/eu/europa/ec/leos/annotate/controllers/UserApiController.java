...
public class UserApiController {
     ...
     * @param connectedEntity the connectedEntity, as request parameter
     *
     * @return 
    ...
    public ResponseEntity<Object> getProfile(final HttpServletRequest request, final HttpServletResponse response,
        ...
        try {
            authUser.getUserInfo().setConnectedEntity(connectedEntity);
            final JsonUserProfile profile = userService.getUserProfile(authUser.getUserInfo());
    ...
    public ResponseEntity<Object> updateUserPreferences(final HttpServletRequest request, final HttpServletResponse response,
        ...
        try {
            userService.updateSidebarTutorialVisible(authUser.getUserInfo().getLogin(), authUser.getUserInfo().getContext(), jsonUserPref.getPreferences().isShow_sidebar_tutorial());
        ...
        return getProfile(request, response, null, null);
    }
