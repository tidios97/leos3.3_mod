...
function AnnotateSentapiAppController(
  ...
  this.buttons = {};
  if (settings.message && settings.message.buttons && settings.message.buttons.yes) {
...
AnnotateSentapiAppController.$inject = ['$document', '$location', '$rootScope', '$route', '$scope', '$window', 'settings', 'api'];
