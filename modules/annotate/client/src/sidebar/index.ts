...
var isLeosDocument = settings.docType && (settings.docType === 'LeosDocument');
...
module.exports = angular.module('h', [
  ...
  // UI components
  .component('annotation', require('./components/annotation')) //LEOS Change
  ...
  .component('dropdownMenu', require('./components/dropdown-menu'))
  .component('excerpt', require('./components/excerpt'))
  .component('groupList', require('./components/group-list')) // LEOS Change
  ...
  .component('markdown', require('./components/markdown')) // LEOS Change
  .component('ckeditorMarkdown', require('./components/ckeditor-markdown')) // LEOS Change
  ...
  .component('suggestionButtons', require('./components/suggestion-buttons'))
  .component('searchInput', require('./components/search-input'))
  .component('selectionTabs', require('./components/selection-tabs'))
  .component('selectionPane', require('./components/selection-pane')) // LEOS Change
  ...
  .component('filterButton', require('./components/filter-button')) // LEOS Change
  .component('filterPane', require('./components/filter-pane')) // LEOS Change
  ...
  .service('suggestionMerger', require('./services/suggestion-merger'))
  ...
  .config(['$provide', '$injector', require('./decorators/leos-oauth-auth')]) //LEOS Change
  .config(['$provide', '$injector', require('./decorators/leos-permissions')]) //LEOS Change
  .run(setupHttp)
...
type ChromeWindow = Window & { chrome: any; } & typeof globalThis;
