...
@Component
public class BillValidationChain extends ValidationChain{
    
    @Autowired
    BillValidationChain(MetadataValidator metadataValidator,
    ...
    public boolean supports(DocumentVO documentVO){
        return LeosCategory.BILL.equals(documentVO.getDocumentType());
    }
}
