...
public interface TransformationService {
    ...
    String toXmlFragmentWrapper(InputStream documentStream, String contextPath, List<LeosPermission> permissions, InputStream coverPageStream);
    
    String toImportXml(InputStream documentStream, String contextPath, List<LeosPermission> permissions);

    String toImportXml(InputStream documentStream, String contextPath, List<LeosPermission> permissions, InputStream coverPageStream);
    ...
    String formatToHtml(XmlDocument versionDocument, String contextPath, List<LeosPermission> permissions, InputStream coverPageStream);
    
    /**
     * This methods gets the content xml from an input stream, converts it in html format
     *
     * @param documentStream content stream of the document to be returned in html format
     * @param contextPath the base path to be used while creating HTML for resources
     * @return document String in html format
     */
    String formatToHtml(InputStream documentStream, String contextPath, List<LeosPermission> permissions);

    String formatToHtml(InputStream documentStream, String contextPath, List<LeosPermission> permissions, InputStream coverPageStream);
}
