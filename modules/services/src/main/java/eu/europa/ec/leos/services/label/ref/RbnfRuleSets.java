 ...
 */
/*
 * LEOS Comment: this files exists here to avoid the pain of finding a good 
 * library which could generate ordinals. I am not plugging in the rules below.
 * But these could be used as starting point.
 * REF: http://icu-project.org/apiref/icu4c/classRuleBasedNumberFormat.html
 */
public class RbnfRuleSets {
    /**
