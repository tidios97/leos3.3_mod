...
@Component
public class ExplanatoryValidationChain extends ValidationChain {

    @Autowired
    ExplanatoryValidationChain(MetadataValidator metadataValidator,
    ...
    public boolean supports(DocumentVO documentVO) {
        return LeosCategory.COUNCIL_EXPLANATORY.equals(documentVO.getDocumentType());
    }
}
