...
public interface ContentComparatorService {
    ...
    String CONTENT_REMOVED_CLASS_CN = "leos-content-removed-cn";
    String CONTENT_ADDED_CLASS = "leos-content-new";
    String CONTENT_ADDED_CLASS_CN = "leos-content-new-cn";
    ...
    String compareDeletedElements(ContentComparatorContext context);
    ...
    default boolean isElementIndexLessThanRootChildren(Element contentRoot, int contentChildIndex) {
        return contentRoot != null && contentRoot.getChildren() != null &&
                contentChildIndex  < contentRoot.getChildren().size();
    }
