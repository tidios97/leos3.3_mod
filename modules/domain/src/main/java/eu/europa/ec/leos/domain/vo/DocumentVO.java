...
public class DocumentVO {
        ...
        switch (xmlDocument.getCategory()) {
            ...
            case COUNCIL_EXPLANATORY:
                ExplanatoryMetadata metadataE = ((Explanatory) xmlDocument).getMetadata()
                        .getOrError(() -> "Explanatory metadata is required");
                this.template = metadataE.getTemplate();
                this.language = metadataE.getLanguage();
                this.setTitle(metadataE.getTitle());

                this.getMetadata().setTitle(metadataE.getTitle());

                this.setTemplate(metadataE.getTemplate());
                this.getMetadata().setDocPurpose(metadataE.getPurpose());
                this.getMetadata().setTemplate(metadataE.getTemplate());
    ...
    public CloneProposalMetadataVO getCloneProposalMetadataVO() { return cloneProposalMetadataVO; }
    ...
    public void setMetadataDocument(LeosMetadata metadataDocument) {
