...
public interface LeosDocumentService {
    ...
    ConvertDocumentInput createDocumentInput(MultipartFile inputFile, boolean isWithAnnotations);

    byte[] getRenditions(ConvertDocumentInput convertDocumentInput);
}
