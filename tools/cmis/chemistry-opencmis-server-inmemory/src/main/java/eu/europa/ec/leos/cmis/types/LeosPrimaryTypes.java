...
final class LeosPrimaryTypes {
    ...
    static TypeDefinition createLeosExportType(TypeDefinition parentType, PropertyDefinition<?>... properties) {
        MutableTypeDefinition leosExportDocType =
                typeFactory.createChildTypeDefinition(parentType, "leos:export");
        leosExportDocType.setDisplayName("LEOS Export Document");
        leosExportDocType.setDescription("LEOS Export Document Type");
        leosExportDocType.setIsCreatable(true);
        addProperties(leosExportDocType, properties);
        return leosExportDocType;
    }
