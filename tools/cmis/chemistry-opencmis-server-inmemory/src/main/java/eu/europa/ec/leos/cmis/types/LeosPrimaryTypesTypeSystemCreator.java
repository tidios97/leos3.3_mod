    ...
    private static List<TypeDefinition> buildTypesList() {
        ...
        TypeDefinition leosXmlDocType =
                LeosPrimaryTypes.createLeosXmlType(
                        ...
                        LeosPropertyDefinition.LEOS_METADATA_EEA_RELEVANCE,
                        LeosPropertyDefinition.LEOS_CLONED_PROPOSAL,
                        LeosPropertyDefinition.LEOS_ORIGIN_REF,
                        LeosPropertyDefinition.LEOS_CLONED_FROM,
                        LeosPropertyDefinition.LEOS_REVISION_STATUS,
                        LeosPropertyDefinition.LEOS_CLONED_MILESTONE_ID,
                        LeosPropertyDefinition.LEOS_BASE_REVISION_ID,
                        LeosPropertyDefinition.LEOS_CONTRIBUTION_STATUS,
        ...
        // create LEOS Export File document type
        typesList.add(LeosPrimaryTypes.createLeosExportType(leosDocType,
                LeosPropertyDefinition.LEOS_INITIAL_CREATED_BY,
                LeosPropertyDefinition.LEOS_INITIAL_CREATION_DATE,
                LeosPropertyDefinition.LEOS_STATUS,
                LeosPropertyDefinition.LEOS_COMMENTS));
