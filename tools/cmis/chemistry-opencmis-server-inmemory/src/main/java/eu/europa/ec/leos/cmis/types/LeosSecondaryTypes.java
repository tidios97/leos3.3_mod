...
final class LeosSecondaryTypes {
    ...
    static TypeDefinition createLeosExplanatoryType(TypeDefinition parentType, PropertyDefinition<?>... properties) {
        MutableTypeDefinition leosExplanatorySecType =
                typeFactory.createChildTypeDefinition(parentType, "leos:explanatory");
        leosExplanatorySecType.setDisplayName("LEOS Explanatory Metadata");
        leosExplanatorySecType.setDescription("LEOS Explanatory Metadata Secondary Type");
        leosExplanatorySecType.setLocalNamespace("leos");
        addProperties(leosExplanatorySecType, properties);
        return leosExplanatorySecType;
    }
