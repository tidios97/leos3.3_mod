...
// ex. C:/devel/sources/pilot/tools/cmis/chemistry-opencmis-server-inmemory/src/main/resources
def resourcesLocalPath = '<TODO>'

// ex. C:/devel/sources/pilot/tools/cmis/chemistry-opencmis-server-inmemory/src/main/webapp/WEB-INF/classes/repository_<instance>.properties
def repoPropertiesFilePropsPath = '<TODO>'

def loader = new LeosLoader(resourcesLocalPath, repoPropertiesFilePropsPath, session)
...
class LeosLoader {
    ...
    static final PROPS_TYPE_MAPPING = [
            ...
            'metadata:eeaRelevance': Boolean.class
    ]
    ...
    LeosLoader(String resourcesLocalPath, String repoPropertiesFilePropsPath, Session session) {
